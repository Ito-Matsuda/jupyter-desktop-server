...
*/
        ...
        // TESTING check if just WS will make it work nope
...
// Set up translations
const LINGUAS = ["cs", "de", "el", "es", "ko", "fr", "nl", "pl", "ru", "sv", "tr", "zh_CN", "zh_TW"];
l10n.setup(LINGUAS);
